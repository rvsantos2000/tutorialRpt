...
Vamos considerar aqui dois grandes paradigmas: programação [**funcional**](https://en.wikipedia.org/wiki/Functional_programming), onde os programas são decompostos em **funções** (*top-down*), e programação [**orientada a objetos**](https://en.wikipedia.org/wiki/Object-oriented_programming) (POO), onde os programas evoluem a partir da interação dos **objetos** existentes no problema (*bottom-up*). 
